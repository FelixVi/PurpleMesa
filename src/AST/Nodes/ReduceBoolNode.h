#ifndef PURPLEMESA_REDUCEBOOLNODE_H
#define PURPLEMESA_REDUCEBOOLNODE_H

#include <AstNode.h>
#include "Traversals/Filters/AstTraversalFilters.h"
#include "Visitors/AstVisitor.h"

struct ReduceBoolNode : AstNode
{
    ReduceBoolNode(AstNodeType nt, const std::shared_ptr<AstNode> &parent) : AstNode(nt, parent) {
    }
    ReduceBoolNode(AstNodeType nt, const std::shared_ptr<AstNode> &parent, int lineno, const std::string &filename) : AstNode(nt, parent, lineno, filename) {
    }
...
#endif //PURPLEMESA_REDUCEBOOLNODE_H
